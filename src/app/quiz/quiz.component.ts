...
export const questions: Question[] = [
    ...
    new Question('Are there any errors in the following code? public void sleep(int hours) { return 8; }', ['There are no errors', 'Change "int hours" to "int: Hours"', 'The method should not return a data type', 'Sleep is a reserved keyword in Java'], 0),
